...
namespace WinForms_Expense_Manager.Forms
{
    public partial class AddNewEntryForm : Form
    {
        ...
        private void buttonAddNewEntry_Click(object sender, EventArgs e)
        {
            ...
            string query = "INSERT INTO t_transactions (c_title, c_desc, c_amount, c_category) VALUES (@Title, @Description, @Value, @Category)";
            ...
            // Add to DataGridView
            // dataGridViewEntries.Rows.Add(title, description, parsedValue, comboBoxCategories.SelectedItem.ToString());
